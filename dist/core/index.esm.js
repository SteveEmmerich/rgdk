import { interval, animationFrameScheduler, fromEvent, combineLatest, Observable } from 'rxjs';
...
export { AssetLoader, CanvasRenderer, FPS, assetLoader, canvasRenderer, click$, clock$1 as clock$, keydown$, keypressed$, keyup$, touch$ };
